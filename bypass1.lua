...
local function InitializeSLUABypass()
    pcall(function()
        ...
        if jit and then jit.attach then jit.attach(function() end, "bc") end
    ...
    pcall(function()
        local function TSSPacketFilter(playerId, tssData)
            ...
            local blacklist = {
                ...
                "TSSHeartBeat", "tss_heart_beat", "memcmp",
                "mprotect", "mincore",
                "report", "segment", "AnoSDK", "qmemcpy", "exception", "violation", "hack", "verify",
